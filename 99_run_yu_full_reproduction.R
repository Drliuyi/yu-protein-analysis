...
source(file.path(project_dir, "R", "full", "00_core.R"))
source(file.path(project_dir, "R", "full", "01_sources_preflight.R"))
source(file.path(project_dir, "R", "full", "02_cohort.R"))
source(file.path(project_dir, "R", "full", "03_cox_associations.R"))
source(file.path(project_dir, "R", "full", "03b_cmr_associations.R"))
source(file.path(project_dir, "R", "full", "04_yys_extension.R"))
source(file.path(project_dir, "R", "full", "04_evaluate_figures.R"))
source(file.path(project_dir, "R", "full", "06_mr.R"))
source(file.path(project_dir, "R", "full", "07_mediation.R"))
source(file.path(project_dir, "R", "full", "08_systems_biology.R"))
...
if (cfg$mode %in% c("all", "all_fast")) {
  stop(
    "Mode=all must be dispatched by tools/run_yu_full_reproduction_windows.ps1 ",
...
if (cfg$mode %in% python_modes) {
  stop("Mode=", cfg$mode, " is dispatched by tools/run_yu_full_reproduction_windows.ps1", call. = FALSE)
}
