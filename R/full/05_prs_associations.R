yur_prs_thresholds <- function(cfg) {
  x <- fread(file.path(cfg$project_dir, "config", "prs_thresholds.tsv"))
...
yur_prs_sources <- function(cfg) {
  x <- fread(file.path(cfg$project_dir, "config", "prs_gwas_sources.tsv"))
...
yur_prs_weight_policy <- function(cfg) {
  path <- file.path(cfg$project_dir, "config", "prs_weight_source_policy.tsv")
...
yur_prs_preflight <- function(cfg) {
  ...
  yur_write_json(list(
    ...
    source_manifest_hash = yur_sha_file(file.path(cfg$project_dir, "config", "prs_gwas_sources.tsv")),
    weight_policy_hash = yur_sha_file(file.path(cfg$project_dir, "config", "prs_weight_source_policy.tsv")),
    threshold_manifest_hash = yur_sha_file(file.path(cfg$project_dir, "config", "prs_thresholds.tsv")),
