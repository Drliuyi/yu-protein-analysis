...
PROJECT_DIR="${PROJECT_DIR:-/mnt/d/UKB_data/scripts/yy_cad_yu_yys}"
ANALYSIS_DIR="${ANALYSIS_DIR:-/mnt/d/UKB_data/analysis/yu_proteomic_repo_v3}"
SOURCE_FILE="${SOURCE_FILE:-${PROJECT_DIR}/config/prs_gwas_sources.tsv}"
THRESHOLD_FILE="${THRESHOLD_FILE:-${PROJECT_DIR}/config/prs_thresholds.tsv}"
...
BATCH_HELPER="${BATCH_HELPER:-${PROJECT_DIR}/tools/build_batched_prs_score.py}"
